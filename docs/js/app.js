...
function renderGer() {
  Plotly.newPlot(
    ...
    withAxes({
      ...
      xaxis: { title: "Na/Al (molar)", range: [0, 1], autorange: false, zeroline: false },
      yaxis: { title: "K/Al (molar)", range: [0, 1], autorange: false, zeroline: false },
      shapes: gerShapes(),
...
function renderFeAl() {
  Plotly.newPlot(
    ...
    withAxes({
      ...
      xaxis: { title: "Al (%)", range: [0, 15], autorange: false },
      yaxis: { title: "Fe (%)", range: [0, 65], autorange: false },
    }),
    plotCfg()
  );
}
...
function renderCuW() {
  ...
  Plotly.newPlot(
    ...
    withAxes({
      ...
      xaxis: { title: "Cu (ppm)", range: [0, 50000], autorange: false },
      yaxis: { title: "Posición de la banda de la mica (nm)", range: [2195, 2227.5], autorange: false },
      shapes: [
  ...
  Plotly.newPlot(
    ...
    withAxes({
      ...
      xaxis: { title: "Cu (ppm)", range: [0, 25000], autorange: false },
      yaxis: { title: "Posición de la banda de la clorita (nm)", range: [2240, 2263], autorange: false },
      shapes: [
...
function renderMagsus() {
  ...
  Plotly.newPlot(
    ...
    withAxes({
      ...
      xaxis: { title: "Susceptibilidad magnética (×10⁻⁵ SI)", type: "log", range: [-2, 5], autorange: false },
...
function drawHole(id) {
  ...
  Plotly.newPlot(
    ...
    withAxes({
      ...
      xaxis: { title: "% en peso", range: [0, 100], autorange: false },
